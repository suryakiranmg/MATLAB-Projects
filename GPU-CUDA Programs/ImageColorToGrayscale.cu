...
// width & height based on gray image
...
int main(int argc, char *argv[]) 
{
  ...
  inputImageFile = wbArg_getInputFile(args, 0); //get the path
  ...
  rgb2gray<<<dimGrid, dimBlock>>>(deviceOutputImageData, deviceInputImageData, imageChannels, imageWidth, imageHeight);
